...
def drawCross(img, center, r, g, b):
    d = 5
    t = 2
    LINE_AA = cv2.LINE_AA if cv2.__version__[0] == '3' else cv2.LINE_AA #https://github.com/llSourcell/Object_Detection_demo_LIVE/issues/7
    color = (r, g, b)
    ctrx = center[0,0]
    ctry = center[0,1]
...
landmarks=np.array([ [144,73], [410,13], [336,175], [718,159], [178,484] ])
NL = len(landmarks)
...
trajectory=np.zeros(shape=(0,2)) #軌跡
...
while(1):
    ...
    pprint.pprint(particles.tolist())
