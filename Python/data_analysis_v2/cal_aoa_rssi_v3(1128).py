...
'T2': {'start_time': 1669600236000, 'tag': 'tag-b', 'answer':(3.25, 3.25)},
'T3': {'start_time': 1669600335000, 'tag': 'tag-b', 'answer':(3.25, 9.25)},
'T4': {'start_time': 1669600624000, 'tag': 'tag-b', 'answer':(9.25, 9.25)},
'T5': {'start_time': 1669600523000, 'tag': 'tag-a', 'answer':(6.25, 6.25)}
}
# T1 a資料遺失
# T2 a資料遺失
# T3 a資料遺失
...
for index, point in enumerate(diverge_points):
    ...
    temp_error = abs(DIFF_37) + abs(DIFF_38) + abs(DIFF_39) + abs(DIFF_CD)
